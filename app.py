    ...
    with col2:
        ...
        st.markdown(f"""
            <div class="kpi-card kpi-sapphire">
                ...
                {val_html}
                <div class="kpi-label">Avg Gross Salary (Month)</div>
                <div class="watermark">
...
with t_col_b:
    st.markdown("<h3 style='font-family: \"Outfit\", sans-serif; font-weight: 700; color: #1e293b; border-left: 4px solid #3f51b5; padding-left: 12px; margin: 0;'>Avg Gross Salary by Experience</h3>", unsafe_allow_html=True)
